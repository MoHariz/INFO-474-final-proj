...
=======
    initialize(node, props) {
        ...
        x.domain([0, d3.max(props.data, function(d) { return d.total_NA_sales; })]);

        y.domain(props.data.map(function(d) { return d.Genre; }))
          .paddingInner(0.1)
          .paddingOuter(0.5);
        ...
        svg.selectAll(".bar")
          ...
          .enter().append("rect")
            ...
            .attr("width", function(d) { return x(d.total_NA_sales); });
...
>>>>>>> 62573e0fd1c6e36b415367fad3a383915f26875b
}
